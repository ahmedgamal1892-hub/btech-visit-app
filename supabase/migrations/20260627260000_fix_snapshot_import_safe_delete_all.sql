-- Fix all snapshot DELETE statements for safe-delete policy compliance.
-- Restores WHERE import_batch_id IS NOT NULL on store_display, sales_achievement, and store_ranking.
-- Regression source: 20260627230000_daily_workbook_ranking_import.sql lines 270-272.

...
const BEFORE_CSS = readFileSync(join(root, '.tmp/sprint13.2-before-report.css'), 'utf8')
...
mkdirSync(join(root, '.tmp/sprint13.2'), { recursive: true })
...
try {
  ...
  writeFileSync(join(root, '.tmp/sprint13.2/meta.json'), JSON.stringify(result, null, 2))
